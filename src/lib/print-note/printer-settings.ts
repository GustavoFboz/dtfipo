...
export const CASE_NOTE_PRINTER_PROFILES: CaseNotePrinterProfile[] = [
  {
    ...
    dpi: 203,
    maxWidthMm: 108,
    suggestedPaperId: "continuous",
  },
  {
    id: "zebra-zd-zq-gk-gx",
    label: "Zebra ZD / ZQ / GK / GX",
    match: /\bzebra\b.*\b(?:zd|zq|gk|gx)\d+/i,
    dpi: 203,
    maxWidthMm: 108,
    suggestedPaperId: "continuous",
  },
  {
    id: "tsc-thermal",
    label: "TSC térmica",
    match: /\btsc\b.*(?:te|da|td|tx|mb|mh|ttp)/i,
    dpi: 203,
    maxWidthMm: 108,
    suggestedPaperId: "continuous",
  },
  ...
  {
    id: "elgin-l42-l42pro",
    label: "Elgin L42 / L42 Pro",
    match: /\belgin\b.*\bl42\b/i,
    dpi: 203,
    maxWidthMm: 108,
    suggestedPaperId: "continuous",
  },
  {
    id: "epson-tm",
    label: "Epson TM",
    match: /\bepson\b.*\btm[-\s]?[a-z0-9]+/i,
    dpi: 203,
    maxWidthMm: 80,
    suggestedPaperId: "80x120",
  },
  {
    id: "bematech-mp",
    label: "Bematech MP",
    match: /\bbematech\b.*\bmp[-\s]?\d+/i,
    dpi: 203,
    maxWidthMm: 80,
    suggestedPaperId: "80x120",
  },
