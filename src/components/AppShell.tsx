...
export function AppShell() {
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-[#fcfdfe] dark:bg-black font-light transition-colors duration-500">
      ...
      <aside
        className={`flex-col bg-white dark:bg-black border-r border-slate-100 dark:border-white/5 z-[60] fixed h-[calc(100vh-72px)] top-[72px] transition-[width] duration-300 ease-in-out select-none ${
