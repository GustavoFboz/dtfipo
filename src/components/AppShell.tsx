        ...
        <div className="flex flex-col h-full overflow-hidden">
          ...
          <div className="mt-auto border-t border-slate-100 dark:border-white/5 bg-white dark:bg-black overflow-hidden flex flex-col">
            <div
              ...
              className="flex items-center justify-center w-full py-6 text-[13px] font-medium tracking-[0.1em] uppercase transition-all border-b border-slate-100 dark:border-white/5 hover:bg-[#54A8FB]/[0.03] active:bg-[#54A8FB]/[0.05] group relative overflow-hidden text-slate-500"
            >
