    ...
    <div className="min-h-screen grid place-items-center bg-background p-4">
      <div className="w-full max-w-md rounded-xl border bg-card p-6 shadow-sm">
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          ...
          <Link to="/auth" search={{ invite: undefined, mode: undefined, plan: undefined, profession: undefined, returnTo: undefined }} className="block text-sm text-center text-muted-foreground hover:underline">
            Voltar
          </Link>
        </form>
      </div>
