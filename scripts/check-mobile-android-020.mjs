...
const release = read("scripts/prepare-android-release.py");
...
expect(workflow.includes("DentalFlow_Android_0.2.1.apk") && release.includes('VERSION = "0.2.1"'), "Android release workflow must package version 0.2.1.");
...
console.log("DentalFlow Android 0.2.1 native/offline/print/notification regressions: OK");
