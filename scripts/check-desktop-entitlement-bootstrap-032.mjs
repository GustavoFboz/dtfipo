...
expect(currentVersion === "0.6.5", `Unexpected DentalFlow Desktop release version: ${currentVersion || "missing"}.`);
...
expect(gate.includes("DentalFlow Desktop 0.6.5"), "The readiness UI must identify the 0.6.5 release.");
