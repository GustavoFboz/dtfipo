...
expect(tauri.includes('"version": "0.2.9"'), "Desktop version must be 0.2.9.");
...
expect(primarySync.includes("DentalFlow Desktop 0.2.9"), "Primary sync gate must identify the 0.2.9 recovery build.");
...
console.log("Desktop 0.2.9 Tauri/SQLite, authenticated sync and reconnect regression checks passed.");
