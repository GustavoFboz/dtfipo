...
DROP POLICY IF EXISTS "auth read backend_backups" ON public.backend_backups;
CREATE POLICY "auth read backend_backups" ON public.backend_backups FOR SELECT TO authenticated USING (true);
DROP POLICY IF EXISTS "auth insert backend_backups" ON public.backend_backups;
